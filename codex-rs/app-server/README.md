...
- `windowsSandbox/setupStart` — start Windows sandbox setup for the selected mode (`elevated` or `unelevated`); returns `{}` immediately and later emits `windowsSandbox/setupCompleted`.
